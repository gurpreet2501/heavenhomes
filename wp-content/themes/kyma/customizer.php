...
Kirki::add_field('kyma_theme', array(
    ...
    'label'             => __('Show Service', 'kyma'),
    'description'       => __('Enable/Disable Service on Home', 'kyma'),
    'section'           => 'service_sec',
    'type'              => 'switch',
    'priority'          => 10,
    'default'           => $kyma_theme_options['home_service_enabled'],
    'sanitize_callback' => 'kyma_sanitize_checkbox',
));
Kirki::add_field('kyma_theme', array(
...
Kirki::add_field('kyma_theme', array(
    ...
    'label'             => __('Show Portfolio', 'kyma'),
    'description'       => __('Enable/Disable Portfolio on Home', 'kyma'),
    'section'           => 'portfolio_sec',
    'type'              => 'switch',
    'priority'          => 10,
    'default'           => $kyma_theme_options['portfolio_home'],
    'sanitize_callback' => 'kyma_sanitize_checkbox',
));
...
Kirki::add_field('kyma_theme', array(
    'settings'          => 'home_blog',
    'label'             => __('Show Latest Posts on Home', 'kyma'),
    'description'       => __('Enable/Disable home blog posts', 'kyma'),
    'section'           => 'blog_sec',
    'type'              => 'switch',
    'priority'          => 10,
    'default'           => $kyma_theme_options['home_blog'],
    'sanitize_callback' => 'kyma_sanitize_checkbox',
));
Kirki::add_field('kyma_theme', array(
...
Kirki::add_field('kyma_theme', array(
    ...
    'label'             => __('Show Extra Content Section on Home', 'kyma'),
    'description'       => __('Enable/Disable home extra content section', 'kyma'),
    'section'           => 'extra_sec',
    'type'              => 'switch',
    'priority'          => 10,
    'default'           => $kyma_theme_options['home_extra_enabled'],
    'sanitize_callback' => 'kyma_sanitize_checkbox',
));
Kirki::add_field('kyma_theme', array(
...
Kirki::add_field('kyma_theme', array(
    ...
    'description'       => __('Enable/Disable Callout section on Home', 'kyma'),
    'section'           => 'callout_sec',
    'type'              => 'toggle',
    'priority'          => 10,
    'transport'         => 'postMessage',
    'default'           => $kyma_theme_options['callout_home'],
    'sanitize_callback' => 'kyma_sanitize_checkbox',
));
