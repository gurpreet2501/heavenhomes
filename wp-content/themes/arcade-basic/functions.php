...
function bavotasan_setup() {
	...
	register_default_headers( array(
		'header01' => array(
			'url' => 'http://theheavenhomes.com/wp-content/themes/arcade-basic/library/images/jjbuilders.jpg',
...
function bootstrap(){
 ...
 wp_enqueue_style('agsoft-css', get_template_directory_uri().'/css/style.css');
 wp_enqueue_style('agsoft-font-awesome', get_template_directory_uri().'/css/font-awesome.css');
 wp_enqueue_script('agsoft-javascript', get_template_directory_uri().'/js/script.js');
 wp_enqueue_script('agsoft-markers', get_template_directory_uri().'/js/markers.js');
}
